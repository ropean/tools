...
//  - favicon:'github'|url → override the favicon: a known alias (see ToolIcon
//                          FAVICON_ALIASES) or a full URL.
...
export const TOOLS = [
  ...
  { id: 'itdog-ping', category: 'dev', name: 'ITDOG Ping (vercel.app)', desc: 'Ping vercel.app from many locations across China (via ITDOG).', favicon: 'https://www.itdog.cn/favicon.ico', external: 'https://www.itdog.cn/ping/vercel.app', ready: true },
];
